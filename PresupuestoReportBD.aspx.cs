    ...
    public void ExportarInfoHorizontal()
    {
        ...
        using (Workbook workbook = new Workbook())
        {
            ...
            try
            {
                ...
                worksheetMovimiento.Cells["K1"].Value = "ENERO";
                worksheetMovimiento.Cells["L1"].Value = "FEBRERO";
                worksheetMovimiento.Cells["M1"].Value = "MARZO";
                worksheetMovimiento.Cells["N1"].Value = "ABRIL";
                worksheetMovimiento.Cells["O1"].Value = "MAYO";
                worksheetMovimiento.Cells["P1"].Value = "JUNIO";
                worksheetMovimiento.Cells["Q1"].Value = "JULIO";
                worksheetMovimiento.Cells["R1"].Value = "AGOSTO";
                worksheetMovimiento.Cells["S1"].Value = "SEPTIEMBRE";
                worksheetMovimiento.Cells["T1"].Value = "OCTUBRE";
                worksheetMovimiento.Cells["U1"].Value = "NOVIEMBRE";
                worksheetMovimiento.Cells["V1"].Value = "DICIEMBRE";
                worksheetMovimiento.Cells["W1"].Value = "TOTAL";
                ...
                worksheetMovimiento.Range["K1:W1"].ColumnWidth = 70;
                ...
                foreach (DataRow row in oData.Rows)
                {
                    ...
                    worksheetMovimiento.Columns["K"][rowActual].Value = m1;
                    worksheetMovimiento.Columns["L"][rowActual].Value = m2;
                    worksheetMovimiento.Columns["M"][rowActual].Value = m3;
                    worksheetMovimiento.Columns["N"][rowActual].Value = m4;
                    worksheetMovimiento.Columns["O"][rowActual].Value = m5;
                    worksheetMovimiento.Columns["P"][rowActual].Value = m6;
                    worksheetMovimiento.Columns["Q"][rowActual].Value = m7;
                    worksheetMovimiento.Columns["R"][rowActual].Value = m8;
                    worksheetMovimiento.Columns["S"][rowActual].Value = m9;
                    worksheetMovimiento.Columns["T"][rowActual].Value = m10;
                    worksheetMovimiento.Columns["U"][rowActual].Value = m11;
                    worksheetMovimiento.Columns["V"][rowActual].Value = m12;

                    worksheetMovimiento.Columns["W"][rowActual].Value = total;

                    rowActual++;
                }


                worksheetMovimiento.Range["K:W"].NumberFormat = "#,##0.00";
    ...
    public void ExportarInfoVertical()
    {
        ...
        using (Workbook workbook = new Workbook())
        {
            ...
            try
            {
                ...
                worksheetMovimiento.Range["K1:M1"].ColumnWidth = 80;
                worksheetMovimiento.Range["A1:M1"].Alignment.WrapText = true;
                worksheetMovimiento.Range["A1:M1"].Alignment.Horizontal = SpreadsheetHorizontalAlignment.Center;
                worksheetMovimiento.Range["A1:M1"].Alignment.Vertical = SpreadsheetVerticalAlignment.Center;
                worksheetMovimiento.Range["A1:M1"].Alignment.Horizontal = SpreadsheetHorizontalAlignment.Left;
                worksheetMovimiento.Range["A1:M1"].Font.Bold = true;
                worksheetMovimiento.Range["A1:M1"].Fill.BackgroundColor = rowColor;
                worksheetMovimiento.Range["A1:M1"].Font.Color = rowColorF;
                ...
                worksheetMovimiento.Range["A1:M" + (rowActual)].Borders.SetAllBorders(Color.Black, BorderLineStyle.Thin);

                // Enable filtering for the specified cell range.
                CellRange range = worksheetMovimiento.Range["A1:M" + (rowActual)];
                worksheetMovimiento.AutoFilter.Apply(range);
    ...
    public void ExportarPlantillaCarga()
    {
        ...
        using (Workbook workbook = new Workbook())
        {
            ...
            try
            {
                ...
                worksheetMovimiento.Cells["N1"].Value = "ABRIL";
                worksheetMovimiento.Cells["O1"].Value = "MAYO";
                worksheetMovimiento.Cells["O1"].Value = "JUNIO";
                worksheetMovimiento.Cells["Q1"].Value = "JULIO";
                worksheetMovimiento.Cells["R1"].Value = "AGOSTO";
                worksheetMovimiento.Cells["S1"].Value = "SEPTIEMBRE";
                worksheetMovimiento.Cells["T1"].Value = "OCTUBRE";
                ...
                worksheetMovimiento.Range["A1:J1"].ColumnWidth = 100;
                worksheetMovimiento.Range["K1:V1"].ColumnWidth = 70;
                worksheetMovimiento.Range["A1:V1"].Alignment.WrapText = true;
                worksheetMovimiento.Range["A1:V1"].Alignment.Horizontal = SpreadsheetHorizontalAlignment.Center;
                worksheetMovimiento.Range["A1:V1"].Alignment.Vertical = SpreadsheetVerticalAlignment.Center;
                worksheetMovimiento.Range["A1:V1"].Font.Bold = true;
                worksheetMovimiento.Range["A1:V1"].Fill.BackgroundColor = rowColor;
                worksheetMovimiento.Range["A1:V1"].Font.Color = rowColorF;
                ...
                foreach (DataRow row in oData.Rows)
                {
                    ...
                    worksheetMovimiento.Columns["K"][rowActual].Value = 0;
                ...
                worksheetMovimiento.Range["K:V"].NumberFormat = "#,##0.00";
                worksheetMovimiento.Range["A1:V" + (rowActual)].Borders.SetAllBorders(Color.Black, BorderLineStyle.Thin);
